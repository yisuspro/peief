    ...
    */
    public function up(){
        $this->dbforge->add_field(array(                                                        //creacion del vector que contiene los campos de la tabla
            ...
            'CTVT_duration' => array(                                                               //columna CTVT_name tipo VARCHAR, tamaño 45
                'type' => 'VARCHAR',
                'constraint' => '45',
            ),
            'CTVT_result' => array(                                                               //columna CTVT_name tipo VARCHAR, tamaño 45
                'type' => 'INT',
                'constraint' => '10',
            ),
            'CTVT_order' => array(                                                               //columna CTVT_name tipo VARCHAR, tamaño 45
                'type' => 'INT',
                'constraint' => '10',
            ),
            'CTVT_status' => array(                                                               //columna CTVT_name tipo VARCHAR, tamaño 45
                'type' => 'INT',
                'constraint' => '10',
            ),
            'CTVT_FK_stages' => array(                                                  //columna CTVT_FK_learning_units tipo int, tamaño 10, auto icremental, solo positivos
                'type' => 'INT',
                'constraint' => 10,
                'unsigned' => TRUE,
            ),
            'CTVT_date_start' => array(                                                        //columna CTVT_address tipo VARCHAR, tamaño 45
                'type' => 'DATETIME',
            ),
            'CTVT_date_final' => array(                                                        //columna CTVT_address tipo VARCHAR, tamaño 45
                'type' => 'DATETIME',
            ),
            
            'CTVT_order' => array(                                                        //columna CTVT_address tipo VARCHAR, tamaño 45
                'type' => 'INT',
                'constraint' => 10,
                'unsigned' => TRUE,
            ),
