    ...
    */
    public function up(){
        $this->dbforge->add_field(array(                                                        //creacion del vector que contiene los campos de la tabla
            ...
            'NEWS_priority' => array(                                                               //columna NEWS_order tipo VARCHAR, tamaño 45
                'type' => 'INT',
                'constraint' => '10',
            ),
            'NEWS_title' => array(                                                               //columna NEWS_order tipo VARCHAR, tamaño 45
                'type' => 'VARCHAR',
                'constraint' => '45',
            ),
            'NEWS_subtitle' => array(                                                               //columna NEWS_order tipo VARCHAR, tamaño 45
                'type' => 'VARCHAR',
                'constraint' => '45',
            ),
            'NEWS_date_create' => array(                                                               //columna NEWS_order tipo VARCHAR, tamaño 45
                'type' => 'DATETIME',
            ),
            'NEWS_date_update' => array(                                                               //columna NEWS_order tipo VARCHAR, tamaño 45
                'type' => 'DATETIME',
            ),
            'NEWS_PK_create' => array(                                                               //columna NEWS_order tipo VARCHAR, tamaño 45
                'type' => 'INT',
                'constraint' => '10',
            ),
            'NEWS_PK_update' => array(                                                               //columna NEWS_order tipo VARCHAR, tamaño 45
                'type' => 'INT',
                'constraint' => '10',
            ),
            'NEWS_content' => array(                                                               //columna NEWS_order tipo VARCHAR, tamaño 45
                'type' => 'TEXT',
            ),
            'NEWS_note' => array(                                                               //columna NEWS_order tipo VARCHAR, tamaño 45
                'type' => 'VARCHAR',
                'constraint' => '255',
            ),
        ));
