    ...
    */
    public function up(){
        $this->dbforge->add_field(array(            //creacion del vector que contiene los campos de la tabla
            ...
            'USLE_date_create' => array(           //columna USLE_date_create tipo DATETIME
                'type' => 'DATETIME',
            ),
            'USLE_date_update' => array(           //columna USLE_date_update tipo DATETIME
                'type' => 'DATETIME',
            ),
            'USLE_PK_create' => array(             //columna USLE_PK_create tipo INT
                'type' => 'INT',
            ),
            'USLE_PK_update' => array(             //columna USLE_PK_update tipo INT
                'type' => 'INT',
            ),
        ));
