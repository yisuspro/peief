    ...
    public function up(){
         $this->dbforge->add_field(array(                           //creacion del vector que contiene los campos de la tabla
            'PRLN_PK' => array(                                     //columna PRLN_PK tipo int, tamaño 10, auto icremental, solo positivos
             ...
             'PRLN_FK_learning_units' => array(                              //columna PRLN_FK_subjects tipo int, tamaño 10, auto icremental, solo positivos
                'type' => 'INT',
                'constraint' => 10,
                'unsigned' => TRUE,
            ),
            
            'PRLN_FK_projects' => array(                              //columna PRLN_FK_subjects tipo int, tamaño 10, auto icremental, solo positivos
                'type' => 'INT',
                'constraint' => 10,
                'unsigned' => TRUE,
            ),
            'PRLN_date_create' => array(                    //columna PRLN_address tipo VARCHAR, tamaño 45
                'type' => 'DATETIME',
            ),
            'PRLN_date_update' => array(                  //columna PRLN_telephone tipo VARCHAR, tamaño 45
                'type' => 'DATETIME',
            ),
            'PRLN_PK_create' => array(                    //columna PRLN_address tipo VARCHAR, tamaño 45
                'type' => 'INT',
            ),
            'PRLN_PK_update' => array(                  //columna PRLN_telephone tipo VARCHAR, tamaño 45
                'type' => 'INT',
            ),
        ));
