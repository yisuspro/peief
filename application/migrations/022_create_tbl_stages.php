    ...
    */
    public function up(){
        $this->dbforge->add_field(array(                //creacion del vector que contiene los campos de la tabla
            ...
            'STGS_FK_projects' => array(                //columna STGS_FK_learning_units tipo int, tamaño 10, solo positivos
                'type' => 'INT',
                'constraint' => 10,
                'unsigned' => TRUE,
            ),
            'STGS_date_start' => array(                 //columna STGS_date_start tipo DATETIME
                'type' => 'DATETIME',
            ),
            'STGS_date_final' => array(                 //columna STGS_date_final tipo DATETIME
                'type' => 'DATETIME',
            ),
            
            'STGS_order' => array(                      //columna STGS_order tipo tipo int, tamaño 10, solo positivos
                'type' => 'INT',
                'constraint' => 10,
                'unsigned' => TRUE,
            ),
