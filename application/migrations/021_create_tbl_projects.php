    ...
    */
    public function up(){
        $this->dbforge->add_field(array(                                                        //creacion del vector que contiene los campos de la tabla
            ...
            'PRJC_date_create' => array(                                                        //columna PRJC_address tipo VARCHAR, tamaño 45
                'type' => 'DATETIME',
            ),
            'PRJC_date_update' => array(                                                        //columna PRJC_telephone tipo VARCHAR, tamaño 45
                'type' => 'DATETIME',
            ),
            'PRJC_PK_create' => array(                                                          //columna PRJC_address tipo VARCHAR, tamaño 45
                'type' => 'INT',
            ),
            'PRJC_PK_update' => array(                                                          //columna PRJC_telephone tipo VARCHAR, tamaño 45
                'type' => 'INT',
            ),
            
            'PRJC_date_start' => array(                                                        //columna PRJC_address tipo VARCHAR, tamaño 45
                'type' => 'DATETIME',
            ),
            
            'PRJC_date_final' => array(                                                        //columna PRJC_address tipo VARCHAR, tamaño 45
                'type' => 'DATETIME',
            ),
        ));
