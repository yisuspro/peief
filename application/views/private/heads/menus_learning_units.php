...
<li class="nav-item start <?php if ($this->uri->segment(1)== "Learning_units"){?>active open<?php }?>">
    <a href="<?= base_url('index.php/Learning_units') ?>" class="nav-link nav-toggle" title="unidades de aprendizaje">
...
<?php }?>
<?php if($this->Logueo->permisosUsuario($id,'v_subject')==true){?>
<li class="nav-item start <?php if ($this->uri->segment(1)== "Subjects"){?>active open<?php }?>">
    <a href="<?= base_url('index.php/Subjects') ?>" class="nav-link nav-toggle" title="Asignaturas">
