                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        ...
                        if (xhr.status == 402) {
                            ...
                            if (json.ROLE_PK.length != 0) {
                                $("#ROLE_PK_alerta > div").html(json.ROLE_PK);
                                document.getElementById('ROLE_PK_alerta').style.display = 'inherit';
                            }
                            if (json.ROLE_name.length != 0) {
                                $("#ROLE_name_alerta > div").html(json.ROLE_names);
                                document.getElementById('ROLE_name_alerta').style.display = 'inherit';
                            }
                            if (json.ROLE_shortname.length != 0) {
                                $("#ROLE_shortname_alerta > div").html(json.ROLE_lastnames);
                                document.getElementById('ROLE_shortname_alerta').style.display = 'inherit';
                            }
                            if (json.ROLE_description.length != 0) {
                                $("#ROLE_description_alerta > div").html(json.ROLE_address);
