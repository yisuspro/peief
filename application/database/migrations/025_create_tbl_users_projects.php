    ...
    */
    public function up(){
        $this->dbforge->add_field(array(                    //creacion del vector que contiene los campos de la tabla
            ...
            'USPR_FK_projects' => array(                    //columna USPR_FK_proyects tipo int, tamaño 10, solo positivos
                'type' => 'INT',
                'unsigned' => TRUE,
            ),
            ...
            'USPR_date_create' => array(                    //columna USPR_date_create tipo DATETIME 
                'type' => 'DATETIME',
            ),
            'USPR_date_update' => array(                    //columna USPR_date_update tipo DATETIME
                'type' => 'DATETIME',
            ),
        ...
        ]);                                                                                                 //creacion de relacion a la tabla projects
        $this->dbforge->add_column('users_projects',[
