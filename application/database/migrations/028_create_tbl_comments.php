    ...
    */
    public function up(){
        $this->dbforge->add_field(array(           //creacion del vector que contiene los campos de la tabla
            ...
            'CMTS_content' => array(               //columna CMTS_content tipo TEXT
                'type' => 'TEXT',
            ),
            'CMTS_FK_news' => array(               //columna CMTS_FK_news tipo int, tamaño 10, auto icremental, solo positivos
                'type' => 'INT',
                'constraint' => 10,
                'unsigned' => TRUE,
            ),
            'CMTS_FK_users' => array(              //columna CMTS_FK_users tipo int, tamaño 10, auto icremental, solo positivos
                'type' => 'INT',
                'constraint' => 10,
                'unsigned' => TRUE,
            ),
        ...
        $this->dbforge->add_column('comments',[    //creacion de relacion a la tabla news
