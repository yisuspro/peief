    ...
    */
    public function up(){
        $this->dbforge->add_field(array(        //creacion del vector que contiene los campos de la tabla
            ...
            'LNUT_date_create' => array(      //columna LNUT_date_create tipo DATETIME
                'type' => 'DATETIME',
            ),
            'LNUT_date_update' => array(      //columna LNUT_date_update tipo DATETIME
                'type' => 'DATETIME',
            ),
            'LNUT_PK_create' => array(        //columna LNUT_PK_create tipo INT
                'type' => 'INT',
            ),
            'LNUT_PK_update' => array(        //columna LNUT_PK_update tipo INT
                'type' => 'INT',
            ),
        ));
